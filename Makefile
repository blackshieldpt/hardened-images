...
IMAGES := nginx nginx-acme node node24 go python python-sodium postgresql valkey minio clickhouse nats openbao manticore mailpit redpanda kafka zookeeper etcd versitygw static
