...
```bash
docker run -d -p 9092:9092 -p 9644:9644 -e REDPANDA_SUPERUSER_PASSWORD=secret -v rpdata:/var/lib/redpanda/data hub.blackshield.pt/test_images/redpanda:26.2.2
```
